...
# ═══════════════════════════════════════════════════════════════════════════════
#  NEW: Qdrant imports (replacing Chroma)
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
#  CUSTOM CSS  —  (unchanged — keep your existing CSS here)
# ═══════════════════════════════════════════════════════════════════════════════
st.markdown(
    """
<style>
/* ── PASTE YOUR ENTIRE EXISTING CSS BLOCK HERE UNCHANGED ── */
...
# ═══════════════════════════════════════════════════════════════════════════════
#  LOAD RAG CHAIN  (cached — built only once) — UPDATED FOR QDRANT
# ═══════════════════════════════════════════════════════════════════════════════
...
Question: {question}"""
    ...
    # ══════════════════════════════════════════════════════════════════════════
    #  Self-Query Retriever (updated translator for Qdrant)
    # ══════════════════════════════════════════════════════════════════════════
    metadata_field_info = [
        AttributeInfo(
            name="title", 
    ...
    retriever = SelfQueryRetriever.from_llm(
        ...
        metadata_field_info,
        structured_query_translator=QdrantTranslator(),  # ← Changed from ChromaTranslator
        enable_limit=False,
        verbose=False,
        search_kwargs={"k": 10}
    )
...
# ═══════════════════════════════════════════════════════════════════════════════
#  SIDEBAR  (updated to show Qdrant instead of Chroma)
# ═══════════════════════════════════════════════════════════════════════════════
with st.sidebar:
    st.markdown(
        """
    ...
    st.markdown(
        ...
        <table style="width:100%; font-size:0.82rem; color:var(--ink-soft); border-collapse:collapse; font-family:var(--font-body);">
          ...
          <tr>
            ...
            <td style="text-align:right; color:var(--ink); border-bottom:1px solid var(--hairline);">Qdrant Cloud</td>
          </tr>
          <tr>
    ...
    st.markdown(
        '<div class="sidebar-footer">CATALOGED WITH STREAMLIT · LANGCHAIN · GROQ · QDRANT</div>',
        unsafe_allow_html=True,
    )
...
# ═══════════════════════════════════════════════════════════════════════════════
#  RENDER PAST MESSAGES (unchanged)
# ═══════════════════════════════════════════════════════════════════════════════
