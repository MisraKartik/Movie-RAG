        ...
        <table style="width:100%; font-size:0.82rem; color:var(--ink-soft); border-collapse:collapse; font-family:var(--font-body);">
          <tr>
            ...
            <td style="text-align:right; border-bottom:1px solid var(--hairline);">
              <code style="background:var(--paper); border:1px solid var(--hairline); color:var(--rust); padding:0.1rem 0.4rem; border-radius:0; font-size:0.76rem; font-family:var(--font-mono);">llama-3.1-8b-instant</code>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style="text-align:right; color:var(--ink);">15</td>
          </tr>
        </table>
        """,
        unsafe_allow_html=True,
